...
Router.route('/scores', { name:'Scores', template:'Scores', subscriptions: function() { return [Meteor.subscribe('getPartiesScores', true), Meteor.subscribe('getScenarios', false)]; }, action: function(){ if(this.ready()) { this.render(); } else { this.render('Loading'); } } });
