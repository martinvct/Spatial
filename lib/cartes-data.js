CartesTXT = [
  ...
  },
  {
    ...
    regles: {
        necessite:['O5'],
        incompatible:['{"planete.distance": {"$lte": 1}}'] 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$or": [{"carteId": "O1", "active": true}, {"carteId": "O2", "active": true}, {"carteId": "O3", "active": true}]}}}'],
        incompatible:[] 
    },
    tags: ["orbite","absurde"],
    categorie: "O", 
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['"communicationsAntenne"+"communicationsGestion"+"attitudeCapteur"+"attitudeMoteur"+"attitudeGestion"'],
        incompatible:[] 
    },
    tags: ["structure"],
    categorie: "Z", 
  ...
  },
  {
    ...
    regles: {
        necessite:['Z5+"communicationsAntenne"+"communicationsGestion"+"attitudeCapteur"+"attitudeMoteur"+"attitudeGestion"'],
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['(Z1/Z2/Z3/Z4)+S3+(J4/J5)+(((Z1/Z2/Z3)+C5)/Z4)'],
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"tags": "energieBatterie", "active": true}}}'],
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"tags": "propulsionMoteur", "active": true}, {"carteId": "S2", "active": true}, {"tags": "attitudeCapteur", "active": true}, {"$or": [{"carteId": "Z1", "active": true}, {"carteId": "Z4", "active": true}]}]}}}'],
        incompatible:['{"deck.cartes": {"$elemMatch": {"$or": [{"carteId": "Z2", "active": true}, {"carteId": "Z3", "active": true}]}}}'] 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"tags": "propulsionMoteur", "active": true}, {"carteId": "S2", "active": true}, {"tags": "attitudeCapteur", "active": true}, {"$or": [{"carteId": "Z2", "active": true}, {"carteId": "Z3", "active": true}]}]}}}'],
        incompatible:['{"deck.cartes": {"$elemMatch": {"$or": [{"carteId": "Z1", "active": true}, {"carteId": "Z4", "active": true}]}}}'] 
    },
    tags: ["attitude","attitudeRoues","attitudeMoteur"], 
    categorie: "A",
    valEur : 5000000,
  ...
  },
  {
    ...
    regles: {
        necessite:[],
        incompatible:['{"deck.cartes": {"$elemMatch": {"$or": [{"carteId": "O5", "active": true}, {"carteId": "I3", "active": true}, {"carteId": "I5", "active": true}, {"carteId": "I7", "active": true}, {"carteId": "I8", "active": true}, {"carteId": "I12", "active": true}, {"carteId": "I16", "active": true}]}}}']
    },
    tags: ["attitude","attitudeMoteur"], 
    categorie: "A",
    valEur : 100000,
    valNrg :  0,
    valPds : 1000,
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"tags": "propulsionMoteur", "active": true}, {"carteId": "S2", "active": true}, {"tags": "attitudeCapteur", "active": true}, {"carteId": "Z2", "active": true}]}}}'],
        incompatible:['{"deck.cartes": {"$elemMatch": {"$or": [{"carteId": "Z1", "active": true}, {"carteId": "Z3", "active": true}, {"carteId": "Z4", "active": true}]}}}'] 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"carteId": "A4", "active": true}, {"carteId": "A5", "active": true}]}}}'],
        incompatible:[] 
    },
    tags: ["instrument", "instrumentTelescope", "instrumentEspace"], 
    categorie: "I",
  ...
  },
  {
    ...
    regles: {
        necessite:[],
        incompatible:['{"deck.cartes": {"$elemMatch": {"carteId": "I3", "active": true}}}'] 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"carteId": "S3", "active": true}, {"$or": [{"carteId": "J4", "active": true}, {"carteId": "J5", "active": true}]}]}}}'],
        incompatible:['{"deck.cartes": {"$elemMatch": {"carteId": "I3", "active": true}}}'] 
    },
    tags: ["instrument", "instrumentScan", "instrumentEspace"], 
    categorie: "I",
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"carteId": "T3", "active": true}}}'],
        incompatible:[] 
    },
    tags: ["instrument", "instrumentScan", "instrumentEspace"], 
    categorie: "I",
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$or": [{"carteId": "I4", "active": true}, {"carteId": "I5", "active": true}]}}}'],
        incompatible:[] 
    },
    tags: ["instrument", "instrumentScan", "instrumentEspace"], 
    categorie: "I",
  ...
  },
  {
    ...
    regles: {
        necessite:[],
        incompatible:['{"deck.cartes": {"$elemMatch": {"carteId": "Z4"}}}'] 
    },
    tags: ["instrument", "instrumentPlanete"], 
    categorie: "I",
    valEur : 10000000,
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$or": [{"carteId": "A4", "active": true}, {"carteId": "A5", "active": true}]}}}'],
        incompatible:[] 
    },
    tags: ["instrument", "instrumentScan"], 
    categorie: "I",
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"carteId": "Z5", "active": true}}}'],
        incompatible:[] 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"carteId": "Z5", "active": true}}, "planete.atmosphere": true}'],
        incompatible:[] 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"carteId": "J2", "active": true}, {"carteId": "J3", "active": true}]}},"planete.atmosphere": true}'],
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"carteId": "Z5", "active": true}, {"carteId": "I10", "active": true}]}}}'],
        incompatible:[] 
    },
    tags: ["atterrisseur"], 
    categorie: "J",
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"carteId": "J8", "active": true}}}'],
        incompatible:[] 
    },
    tags: ["atterrisseur"], 
    categorie: "J",
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"carteId": "CE2", "active": true}, {"carteId": "CZ1", "active": true}]}}}'],
        incompatible:[] 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"carteId": "CE3", "active": true}, {"carteId": "CZ2", "active": true}]}}}'],
        incompatible:[] 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes":{ "$elemMatch": {"carteId": "CC3", "active": true}}}'],
        incompatible:[] 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes":{ "$elemMatch": {"carteId": "CC4", "active": true}}}'],
        incompatible:[] 
    },
    tags: ["communications","communicationsTelecom"], 
    categorie: "C",
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes":{ "$elemMatch": {"tags": "attitudeMesure", "active": true}}}'],
        incompatible:[] 
    },
