...
Meteor.methods({
	...
	*/
	newPartie: function(_scenarioId){
		...
		var partie = {userId: userId, dateDebut: new Date(), dateModif: new Date(), deck:{cartes:[], energieMax:0, budgetMax:0, masseMax:0, volumeMax:0, energie:0, budget:0, masse:0, volume:0, science:0}, eventIds:[], scenarioId: scenario._id, score: 0, logs:[], peers:[], experts:[], chat:[], finie: false, active: true};	
  		try{
