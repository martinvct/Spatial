CartesTXT = [
  ...
  },
  {
    ...
    description : {fr:"Grâce à une équipe de hackers, vous prenez le contrôle de n'importe quelle antenne d'autres satelittes. Ce segment sol convient à toutes les missions.", en:"Thanks to a team of hackers , you take control of any other antenna satelittes . This ground segment is suitable for all missions."},
    tip: {fr:"", en:""},
    regles: {
        necessite:[],
        incompatible:[] 
  ...
  },
  {
    ...
    description : {fr:"Ce système bien connu des marins a été amélioré, pour une communication avec la Terre via un faisceau laser rouge modulé par le code morse. Il nécessite d'être pointé très précisément vers la Terre, puisqu'il faut observer le clignotement pour connaître le message.", en:"This well-known marine system has been improved , for communication with the Earth using a red laser beam modulated by Morse code . It needs to be pointed precisely toward Earth , since we must observe the flashing to hear the message."},
    tip: {fr:"", en:""},
    regles: {
        necessite:[],
        incompatible:[] 
  ...
  },
  {
    ...
    description : {fr:"Ils fournissent 150W quand ils sont éclairés non loin de la Terre, 300W près de Vénus, 900W près de Mercure.", en:"They provide 150W when illuminated near the Earth, Venus nearly 300W , 1kW near Mercure."},
    tip: {fr:"", en:""},
    regles: {
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"carteId": "P1", "active": true}, {"carteId": "S2", "active": true}, {"tags": "attitudeCapteur", "active": true}, {"$or": [{"carteId": "Z1", "active": true}, {"carteId": "Z4", "active": true}]}]}}}'],
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"carteId": "P1", "active": true}, {"carteId": "S2", "active": true}, {"tags": "attitudeCapteur", "active": true}, {"$or": [{"carteId": "Z2", "active": true}, {"carteId": "Z3", "active": true}]}]}}}'],
  ...
  },
  {
    ...
    description : {fr:"Une souris, un hamster et un cochon d'inde actionnent des roues gyroscopiques pour maintenir l'attitude du vaisseau, un système économe mais de durée de vie faible. Attention au module de vie nécessaire pour la survie des animeaux.", en:"Mouse, hamster and guinea pig operate gyroscopic wheels to maintain the attitude of the vessel, an efficient system but low life. Attention to life module necessary for the survival of animals."},
    tip: {fr:"", en:""},
    regles: {
        necessite:[],
        incompatible:[] 
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"carteId": "J1", "active": true}}}'],
        incompatible:[] 
    },
    tags: ["atterrisseur"], 
    categorie: "J",
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$and": [{"carteId": "J1", "active": true}, {"carteId": "I10", "active": true}]}}}'],
        incompatible:[] 
    },
    tags: ["atterrisseur"], 
    categorie: "J",
