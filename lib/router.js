...
Router.route('/partie/:_scenarioId/:_id', { name:'Partie', template:'Partie', waitOn: function(){ return [Meteor.subscribe('getScenario', this.params._scenarioId, false), Meteor.subscribe('getPartie', this.params._id)]; }, data: function() { d = { scenarioId: this.params._scenarioId, partieId: this.params._id }; return d; } }); 