CartesTXT = [
  {
    ...
    regles: {
        necessite:[],
        incompatible:['{"deck.cartes": {"$elemMatch": {"$or": [{"carteId": "O3", "active": true}, {"carteId": "O4", "active": true}, {"carteId": "O5", "active": true}, {"carteId": "O6", "active": true}]}}}']
    },
    tags: ["lanceur"],
    categorie: "L", 
    valEur : 15000000,
  ...
  },
  {
    ...
    description : {fr:"Suite à une manoeuvre précise, vous utilisez un trou de ver vous permettant de rejoindre n'importe quelle destination.", en:"Following a precise maneuver, using a wormhole connecting you to any destination."},
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"$or": [{"carteId": "O1", "active": true}, {"carteId": "O2", "active": true}, {"carteId": "O3", "active": true}]}}}'],
        incompatible:[] 
  ...
  },
  {
    ...
    description : {fr:"Accompagnant un atterrisseur seul (sans orbiteur associé), il lui permet d'effectuer le trajet interplanétaire.", en:"Accompanying one lander (without associated orbiter ), it allows them to perform the interplanetary journey."},
  ...
  },
  {
    ...
    regles: {
        ...
        incompatible:['{"$or":[{"objectif": "espace"},{"planete.atterrisseur": false }]}'] 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:['{"deck.cartes": {"$elemMatch": {"carteId": "S2", "active": true}}}'],
        incompatible:[] 
    },
  ...
  },
  {
    ...
    regles: {
        necessite:[],
        incompatible:['{"deck.cartes": {"$elemMatch": {"$or": [{"carteId": "I3", "active": true}, {"carteId": "I5", "active": true}, {"carteId": "I7", "active": true}, {"carteId": "I8", "active": true}, {"carteId": "I12", "active": true}, {"carteId": "I16", "active": true}]}}}']
    }, 
  ...
  },
  {
    ...
    tags: ["propulsion", "propulsionInterplanetaire"], 
    categorie: "P",
    valEur : [{condition: '{"deck.cartes": {"$exists": true}}', valeur: 70000000}, {condition: '{"deck.cartes": {"$elemMatch": {"carteId": "O6", "active": true}}}', valeur: 35000000}],
    valNrg :  0,
    valPds : 850000,
    valVol : 0,
    valSci : 1,
