...
Meteor.methods({
	...
	*/
	...
	scoreDeck: function(partie, scenario){
		...
		if(scenario.score.seuilTps < (partie.tempsTotal / 60)){
		 score = score - (((partie.tempsTotal / 60) - scenario.score.seuilTps) * scenario.score.ptsParTps);
		}
		if(score < 0) return 0;
		return score;
	},
	...
	*/
	updateConstantes: function(partie, scenario, dateModif){
		...
		partie.deck.budgetMax  = partie.deck.budget - scenario.initialisation.budgetGestion;
		partie.deck.masse      = 0;
		partie.deck.masseMax   = 0;
		partie.deck.volume     = 0;
		partie.deck.volumeMax  = 0;
