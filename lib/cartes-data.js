CartesTXT = [
  ...
  },
  {
    ...
    valEur : 45000000,
    valNrg : 0,
    valPds : [{condition: '{"$or":[{"deck.cartes.carteId": "O1"},{"deck.cartes.carteId": "O2"}]}', valeur: 5000000}, {condition: '{"$or":[{"deck.cartes.carteId": "O3"},{"deck.cartes.carteId": "O4"}]}', valeur: 3000000}, {condition: '{"$or":[{"deck.cartes.carteId": "O5"},{"deck.cartes.carteId": "O6"}]}', valeur: 1600000}],
    valVol : 0,
    valSci : 0,
    fiabilite: 0.80,
    active : true,
  ...
  },
  {
    ...
    valEur : 30000000,
    valNrg : 0,
    valPds : [{condition: '{"$or":[{"deck.cartes.carteId": "O1"},{"deck.cartes.carteId": "O2"}]}', valeur: 5000000}, {condition: '{"$or":[{"deck.cartes.carteId": "O3"},{"deck.cartes.carteId": "O4"}]}', valeur: 2500000}, {condition: '{"$or":[{"deck.cartes.carteId": "O5"},{"deck.cartes.carteId": "O6"}]}', valeur: 1000000}],
    valVol : 0,
    valSci : 0,
    fiabilite: 0.40,
    active : true,
  ...
  },
  {
    ...
    valEur : 150000000,
    valNrg : 0,
    valPds : [{condition: '{"$or":[{"deck.cartes.carteId": "O1"},{"deck.cartes.carteId": "O2"}]}', valeur: 20000000}, {condition: '{"$or":[{"deck.cartes.carteId": "O3"},{"deck.cartes.carteId": "O4"}]}', valeur: 10000000}, {condition: '{"$or":[{"deck.cartes.carteId": "O5"},{"deck.cartes.carteId": "O6"}]}', valeur: 4000000}],
    valVol : 0,
    valSci : 0,
    fiabilite: 0.90,
    active : true,
  ...
  },
  {
    ...
    description : {fr:"Le senseur solaire estime approximativement l'attitude du CubeSat en utilisant la direction du Soleil. Leur précision est faible, mais ils s'avèrent très utiles en cas de perte de stabilité du vaisseau.", en:"The solar sensor feels about the attitude of the CubeSat using the direction of the sun."},
    tip: {fr:"Au moins un système de mesure d'attitude est obligatoire.", en:"At least one attitude measurement system is required."},
    regles: {
        necessite:'',
        incompatible:'' 
