...
Router.route('/scenarios', { name: 'ConfigScenarios', template:'ConfigScenarios', waitOn: function(){ return Meteor.subscribe('scenarios'); } } );
Router.route('/utilisateurs', { name: 'ConfigUtilisateurs', template:'ConfigUtilisateurs', waitOn: function(){ return Meteor.subscribe('allUsersData'); } } );