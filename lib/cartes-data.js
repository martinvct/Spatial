CartesTXT = [
  ...
  },
  {
    ...
    description : {fr:"Cette orbite est obligatoire pour passer facilement d'une planète à l'autre. Une fois la manoeuvre effectuée, le vaisseau fait un survol (flyby), se met en orbite autour de l'objet ou l'utilise pour aller plus loin (fronde gravitationnelle).", en:"This orbit allows to easily switch from one planet to another."},
    tip: {fr:"<span class='mandatory'>Obligatoire si mission interplanétaire, ne peut être utilisée seule.</span>", en:"<span class='mandatory'>Required if interplanetary mission may not be used alone</span>"},
    regles: {
        necessite:'O1/O2/O3/O4/O8/Z4',
        incompatible:'{"objectif": "espace"}/{"planete.distance": 0}' 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:'"thermiquePassif"§ +"energieGenerateur"§ +"energieGestion"§ +"commandesCalculateur"§ + "orbite"§ + "instrument"§ +"attitudeMoteur"§ +"attitudeGestion"§ +"communicationsAntenne"§ +"communicationsGestion"§ +"propulsion"§',
        incompatible:'' 
    },
    tags: ["structure"],
    categorie: "Z", 
  ...
  },
  {
    ...
    description : {fr:"Une mission composée uniquement d'un atterrisseur a besoin d'un tel module pour effectuer le trajet interplanétaire.", en:"Accompanying one lander (without associated orbiter ), it allows them to perform the interplanetary journey."},
    ...
    regles: {
        necessite:'Z5 + O5 + "attitudeMoteur"§ +"attitudeGestion"§ +"propulsion"§ + "thermiquePassif"§',
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:'(((C5§ / ("communicationsAntenne"§ + "communicationsGestion"§)) + (Z1/Z2/Z3/Z4)) / ("communicationsAntenne"§ + "communicationsGestion"§ + Z4)) + S3 + "energieGenerateur"§ + "atterrisseurInstrument"§',
  ...
  },
  {
    ...
    tip: {fr:"<span class='mandatory'>Obligatoire</span>", en:"<span class='mandatory'>Mandatory</span>"},
    regles: {
        necessite:'',
        incompatible:'' 
    },
  ...
  },
  {
    ...
    tip: {fr:"<span class='mandatory'>Obligatoire si panneau solaire</span>", en:"<span class='mandatory'>Mandatory if solar panel</span>"},
    regles: {
        necessite:'',
        incompatible:'' 
    },
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:'"propulsion"§ + (S2/S3) + "attitudeCapteur"§ + Z3',
        incompatible:'Z1/Z2/Z4/Z5/A6§'
    },
    tags: ["attitude","attitudeRoues","attitudeMoteur"], 
    categorie: "A",
    valEur : 5000000,
  ...
  },
  {
    ...
    regles: {
        necessite:'',
        incompatible:'I21§ / I5§ / I7§ / I8§ / I12§ / I16§ / A9§ / A4§ / A5§ / S2'
    },
  ...
  {
    _id: "K2eRAMcET2tmbfBbq",
    carteId: "A10",
    intitule : {fr:"Capteur de pointage fin (FGS)", en:"Fine Guidance Sensor"},
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:'{"objectif": "espace"} + "attitudeCapteur"§ + "attitudeRoues"§',
        incompatible:'A6§' 
    },
    tags: ["attitude"], 
    categorie: "A",
  ...
  },
  {
    ...
    carteId: "P1",
    intitule : {fr:"Gros Moteurs d'appoint", en:"Big Extra motors"},
  ...
  },
  {
    ...
    regles: {
        necessite:'O5',
        incompatible:'{"planete.distance": {"$gt": 1}}' 
    },
    tags: ["propulsion", "propulsionInterplanetaire"], 
    categorie: "P",
    valEur : [{condition: '{"objectif": {"$exists": true}}', valeur: 30000000}, {condition: '{"deck.cartes": {"$elemMatch": {"carteId": "O8", "active": true}}}', valeur: 25000000}],
    valNrg :  0,
    valPds : 400000,
    valVol : 0,
    valSci : 0,
  ...
  },
  {
    ...
    regles: {
        necessite:'O5',
        incompatible:'{"planete.distance": {"$lt": 2}}' 
    },
    tags: ["propulsion", "propulsionInterplanetaire"], 
    categorie: "P",
    ...
    valNrg :  0,
    valPds : [{condition: '{"deck.cartes": {"$exists": true}}', valeur: 850000}, {condition: '{"deck.cartes": {"$elemMatch": {"carteId": "O6", "active": true}}}', valeur: 425000}],
    valVol : 0,
    valSci : 1,
    fiabilite: 1,
    active : true,
  ...
  },
  {
    ...
    tags: ["propulsion", "propulsionInterplanetaire"], 
    categorie: "P",
    valEur : [{condition: '{"deck.cartes": {"$exists": true}}', valeur: 50000000}, {condition: '{"deck.cartes": {"$elemMatch": {"carteId": "O8", "active": true}}}', valeur: 47500000}, {condition: '{"deck.cartes": {"$elemMatch": {"carteId": "O6", "active": true}}}', valeur: 25000000}, {condition: '{"deck.cartes": {"$elemMatch": {"$and": [{"carteId": "O6", "active": true},{"carteId": "O8", "active": true}]}}}', valeur: 23750000}],
    valNrg :  500,
    valPds : [{condition: '{"deck.cartes": {"$exists": true}}', valeur: 150000}, {condition: '{"deck.cartes": {"$elemMatch": {"carteId": "O6", "active": true}}}', valeur: 75000}],
    valVol : 0,
    valSci : 0,
    fiabilite: 1,
    active : true,
  ...
  },
  {
    ...
    description : {fr:"Il permet de construire un observatoire spatial simple. Comme tout téléscope, il doit être complété par un imageur ou un spectromètre.", en:"Lets build a simple space observatory , eg . for scans of the sky or the low-resolution mapping."},
    tip: {fr:"", en:""},
    regles: {
        necessite:'',
        incompatible:'' 
  ...
  },
  {
    ...
    carteId: "I4",
    intitule : {fr:"Imageur visible basse résolution", en:"Visible detector low resolution"},
  ...
  },
  {
    ...
    description : {fr:"Disposé à la sortie d'un télescope, il permet d'avoir une première idée de nombreuses propriétés des astres observés (composition, vitesse, ...) mais il nécessite un pointage précis.", en:"Disposed at the outlet of a telescope , it allows to evaluate many properties observed stars (composition, speed , ...) but it requires a precise pointing."},
    tip: {fr:"", en:""},
    regles: {
        necessite:'(I1§ / I2§ ) + "attitudeRoues"§',
        incompatible:'I3§' 
    },
    tags: ["instrument", "instrumentScan", "instrumentEspace"], 
    categorie: "I",
  ...
  },
  {
    ...
    carteId: "I6",
    intitule : {fr:"Imageur IR", en:"IR Detector"},
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:'T3§ + "attitudeRoues"§ + (I1§ / I2§ / I3§)',
        incompatible:'' 
    },
    tags: ["instrument", "instrumentScan", "instrumentEspace"], 
    categorie: "I",
  ...
  },
  {
    ...
    description : {fr:"Disposé à la sortie d'un télescope, il permet d'étudier en détail la composition atomique de toute une zone du ciel mais il nécessite un pointage précis.", en:"Located at the outlet of a telescope he used to study in detail the atomic composition of a whole area of ​​the sky but it requires precise pointing."},
    tip: {fr:"", en:""},
    regles: {
        necessite:'"attitudeRoues"§ + (I1§ / I2§ / I3§)',
        incompatible:'' 
    },
    tags: ["instrument", "instrumentScan", "instrumentEspace"], 
    categorie: "I",
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:'(I1§ / I2§ / I3§) + (I4§ / I5§ / I20§ / I21§)',
        incompatible:'' 
    },
    tags: ["instrument", "instrumentScan", "instrumentEspace"], 
    categorie: "I",
  ...
  },
  {
    ...
    tip: {fr:"", en:""},
    regles: {
        necessite:'{"planete.atterrisseur": true } + "attitudeRoues"§',
        incompatible:'Z5§'
    },
    tags: ["instrument", "instrumentPlanete"], 
    categorie: "I",
  ...
  },
  {
    ...
    carteId: "I20",
    intitule : {fr:"Imageur visible haute résolution", en:"Visible detector high resolution"},
  ...
  },
  {
    ...
    description : {fr:"Le bouclier thermique protège les atterrisseurs lorsqu'ils traversent une atmosphère.", en:"The heat shield protects the undercarriages during their passage through the atmosphere."},
    tip: {fr:"", en:""},
    regles: {
  ...
  },
  {
    ...
    description : {fr:"Le parachute permet de ralentir l'atterrisseur. Il ne fonctionne que pour les lunes (ex: Titan) et planètes (ex: Mars, Vénus) possédant une atmosphère.", en:"The parachute slows the lander . It only works for the moons and planets with an atmosphere."},
    tip: {fr:"", en:""},
    regles: {
        necessite:'J2§ + Z5§ + {"planete.atmosphere": true}',
        incompatible:'' 
    },
  ...
  },
  {
    ...
    tags: ["atterrisseur","atterrisseurInstrument"], 
    categorie: "J",
    valEur : 20000000,
    valNrg : 7,
    valPds : 20000,
  ...
  },
  {
    ...
    regles: {
        necessite:'CL1 +"energieGenerateur"§ +"energieGestion"§ +"commandesProcesseur"§ + "instrument"§ +"attitudeMesure"§ +"communicationsAntenne"§ +"communicationsTelecom"§',
        incompatible:'CL2' 
    },
  ...
  },
  {
    ...
    description : {fr:"La structure, ou plateforme, est le squelette du vaisseau. Elle assure sa rigidité et contient tous les connecteurs où fixer les cartes-équipements.", en:"The structure or platform, the vessel is backbone. It provides rigidity and contains all the connectors that attach the card-equipment."},
    tip: {fr:"Cette structure doit être utilisée pour un projet 3U.", en:"This structure must be used for a 3U project."},
    regles: {
        necessite:'CL2 +"energieGenerateur"§ +"energieGestion"§ +"commandesProcesseur"§ + "instrument"§ +"attitudeMesure"§ +"communicationsAntenne"§ +"communicationsTelecom"§',
        incompatible:'CL1' 
    },
  ...
  },
  {
    ...
    description : {fr:"Cette antenne se place sur un côté du CubeSat. Elle ne fonctionne que pour certaines fréquences (Bande S) et nécessite un système Télécom rapide.", en:"This antenna is located on one side of CubeSat . It only works for certain frequencies ( Band S)."},
    tip: {fr:"", en:""},
    regles: {
        necessite:'CC2',
        incompatible:'' 
  ...
  },
  {
    ...
    description : {fr:"Les panneaux solaires se fixent sur 5 côtés des unités (la 6éme face étant utilisée pour l'antenne). Quand le CubeSat 1U est éclairé, l'ensemble de ces panneaux fournit 3W.", en:"Solar panels are fixed on 5 sides of the units ( the 6th face being used for the antenna) . When the CubeSat is illuminated , the set of these panels provides 3W."},
    tip: {fr:"<span class='mandatory'>Obligatoire pour 1U</span>", en:"<span class='mandatory'>Mandatory for 1U</span>"},
    regles: {
        necessite:'',
        incompatible:'' 
    },
  ...
  },
  {
    ...
    description : {fr:"Les panneaux solaires se fixent sur 4 long côtés du CubeSat 3U. Quand ils sont éclairés, l'ensemble de ces panneaux fournit 6W.", en:"Solar panels are fixed on four long sides of the CubeSat . When the latter is illuminated , the set of these panels provides 6W."},
    tip: {fr:"<span class='mandatory'>Obligatoire pour 3U</span>", en:"<span class='mandatory'>Mandatory for 3U</span>"},
    regles: {
        necessite:'',
        incompatible:'' 
    },
