CartesTXT = [
  ...
  },
  {
    ...
    regles: {
        necessite:[],
        incompatible:['{"deck.cartes": {"$elemMatch": {"tags": "instrument", "active": true}}}'] 
    },
    tags: ["structure"],
    categorie: "Z", 
    valEur : 10000000,
  ...
  },
  {
    ...
    categorie: "E", 
    valEur : 2000000,
    valNrg :  [{condition: '{"planete.distance": 0}', valeur: 150}, {condition: '{"planete.distance": 1}', valeur: 300}, {condition: '{"planete.distance":{"$gte": 2}}', valeur: 1000}],
    valPds : 10000,
    valVol : 0,
    valSci : 0,
    fiabilite: 1,
